...
function ScheduleDay({ dayNumber, date }: ScheduleDay) {
    ...
    return (
        <button
            ...
            className={`${setColor} h-[50px] flex justify-center items-center rounded-full font-bold transition-all xl:hover:scale-110 xl:hover:shadow-xl xl:h-24 xl:hover:cursor-pointer`}
        >
            {dayNumber}
        </button>
    );
